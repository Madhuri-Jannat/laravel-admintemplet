...
@section('content')
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="panel">
                <div class="d-flex justify-content-end"> <a href="{{url('/students/create')}}" class="btn btn-success"> New student</a></div>
                    ...
                    <table class="table align-middle mb-0" id="ordersTable" data-searchable-table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$student->name}}</td>
                                <td><span class="badge text-bg-success">{{$student->gender}}</span></td>
                                <td>$1,240</td>
                                <td>May 6, 2026</td>
